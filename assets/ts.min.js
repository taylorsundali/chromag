...
function _classCallCheck(e, t) {
  ...
  var i = n(3),
    ...
    s = function() {
      function e(t, n) {
        _classCallCheck(this, e), this.element = t, this.delegateElement = new domDelegate.Delegate(this.element), this.activator = n.activator || document.querySelector('[aria-controls="' + t.getAttribute("id") + '"]'), this.preferredPosition = "bottom", this.isOpen = !1, this.onValueChanged = n.onValueChanged || function() {}, this.onOpen = n.onOpen || function() {}, this.onClose = n.onClose || function() {}, this.showOverlay = void 0 === n.showOverlay || n.showOverlay, this.pageOverlayElement = document.querySelector(".PageOverlay"), this._attachListeners()
      }
      return _createClass(e, [{
        key: "destroy",
        value: function() {
        ...
        value: function(e) {
          ...
          if (this.options.useAjaxCart) {
            ...
            var i = this.element.querySelector('form[action^="/cart/add"]');
             ...
             var o = (new FormData(i), new XMLHttpRequest());
            var success_callback = function(o){
              n.removeAttribute("disabled"), t.element.dispatchEvent(new CustomEvent("product:added", {
                bubbles: !0,
                detail: {
            ...
            var error_callback = function(content) {
  ...
  var i = n(3),
    a = function() {
      ...
      return _createClass(e, [{
        ...
        key: "_closeSearch",
        value: function() {
          this.searchElement.setAttribute("aria-hidden", "false"), document.documentElement.classList.remove("no-scroll"), i.default.removeTrapFocus(this.searchElement, "search")
        }
      }, {
